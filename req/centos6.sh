...
if [ "$OS" == "x86_64" ]; then
  wget https://raw.githubusercontent.com/airblue/OS-script/master/rpmforge-release-0.5.3-1.el6.rf.x86_64.rpm
  rpm -Uvh rpmforge-release-0.5.3-1.el6.rf.x86_64.rpm
else
  wget https://raw.githubusercontent.com/airblue/OS-script/master/rpmforge-release-0.5.3-1.el6.rf.i686.rpm
...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/airblue/OS-script/master/screenfetch"
...
# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/airblue/OS-script/master/centos6/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/airblueOS-script/master/centos6/1194-centos.conf"
if [ "$OS" == "x86_64" ]; then
  wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/airblue/OS-script/master/centos6/1194-centos64.conf"
fi
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/airblue/OS-script/master/centos6/iptables.up.rules"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.githubusercontent.com/airblue/OS-script/master/centos6/open-vpn.conf"
sed -i $MYIP2 /etc/openvpn/1194-client.ovpn;
PASS=`cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 15 | head -n 1`;
useradd -M -s /bin/false airblue
...
# install stunnel
yum install stunnel
wget -O /etc/pki/tls/certs/stunnel.pem "https://raw.githubusercontent.com/airblue/OS-script/master/updates/stunnel.pem"
wget -O /etc/stunnel/stunnel.conf "https://raw.githubusercontent.com/airblue/OS-script/master/updates/stunnel.conf"
...
# download script
cd
wget https://raw.githubusercontent.com/airblue/OS-script/master/updates/install-premiumscript.sh -O - -o /dev/null|sh
