...
wget https://raw.githubusercontent.com/airblue18/OS-script/vnstat_php_frontend-1.5.1.tar.gz
...
wget -O /etc/stunnel/stunnel.pem "https://raw.githubusercontent.com/airblue18/OS-script/master/updates/stunnel.pem"
wget -O /etc/stunnel/stunnel.conf "https://raw.githubusercontent.com/airblue18/OS-script/master/req/stunnel.conf"
...
# setting banner
rm /etc/issue.net
wget -O /etc/issue.net "https://raw.githubusercontent.com/airblue18/OS-cript/master/issue.net"
...
# download script
cd
wget https://raw.githubusercontent.com/airblue18/OS-script/master/updates/install-premiumscript.sh -O - -o /dev/null|sh
